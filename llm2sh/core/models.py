...
class CommandResult(BaseModel):
    ...
    explanation: str = Field(
        default="",
        description="Plain-English breakdown of what the command does"
    )
    ...
    risk_level: RiskLevel = Field(
        ...
        description="The evaluated safety risk level of executing the command"
    )
    ...
    is_pipeline: bool = Field(
        default=False,
        description="True if the command contains multiple piped commands, False otherwise"
    )
    estimated_effect: str = Field(
        default="",
        description="A concise description of the exact effect this command will have on the system"
    )
